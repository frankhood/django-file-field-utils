...
coverage: ## check code coverage quickly with the default Python
	coverage run --source file_field_utils runtests.py tests
	coverage report -m
	coverage html
	open htmlcov/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/django-file-field-utils.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ file_field_utils
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
